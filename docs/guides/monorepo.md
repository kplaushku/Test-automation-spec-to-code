# Using Specto in a Monorepo

A Specto project is **directory-scoped**: the project is whichever directory
contains `.specify/`. A monorepo can hold several independent Specto projects
...
├── apps/
│   ├── web/
│   │   └── .specify/         # Specto project "web"
│   │       └── memory/constitution.md
│   └── api/
│       └── .specify/         # Specto project "api"
│           └── memory/constitution.md
└── packages/
    └── ui/
        └── .specify/         # Specto project "ui"
```
...
Specto project is reported as its resolved absolute path:
...
ERROR: SPECIFY_INIT_DIR is not a Specto project (no .specify/ directory): /home/you/my-monorepo/apps
```
...
> [!NOTE]
> Specto project files are scoped to the **resolved project root**, but Git
...
`/speckit.constitution` edits the local project's file. Specto does not provide
