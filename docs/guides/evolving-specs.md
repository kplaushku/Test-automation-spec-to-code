...
- **Specto project-file updates** refresh managed commands, scripts,
...
Use the [upgrade workflow](../upgrade.md) when you need newer Specto project
...
## Before Updating Specto Project Files

Before refreshing Specto project files with the terminal command
