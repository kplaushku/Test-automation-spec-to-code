...
If you want to try Specto without installing it permanently, use `uvx` to run it directly. This downloads the tool into a temporary environment that is discarded after the command finishes.
...
If you plan to use Specto regularly, a persistent installation is recommended:
