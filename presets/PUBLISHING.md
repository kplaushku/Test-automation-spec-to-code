...
This guide explains how to publish your preset to the Specto preset catalog, making it discoverable by `specify preset search`.
...
- **Cover the minimum structure** so a reader can decide whether the preset fits:
  ...
  - The install command using Specto CLI syntax (above)
