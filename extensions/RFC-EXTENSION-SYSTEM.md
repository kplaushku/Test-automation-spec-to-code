...
Introduce an extension system to Specto that allows modular integration with external tools (Jira, Linear, Azure DevOps, etc.) without bloating the core framework. Extensions are self-contained packages installed into `.specify/extensions/` with declarative manifests, versioned independently, and discoverable through a central catalog.
...
Specto uses two catalog files with different purposes:
...
| Extension Feature | Specto Version | AI Agent Support |
|-------------------|------------------|------------------|
...
This RFC proposes a comprehensive extension system for Specto that:
