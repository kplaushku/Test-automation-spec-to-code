...
This guide explains how to publish your extension to the Specto extension catalog, making it discoverable by `specify extension search`.
...
Specto uses a dual-catalog system. For details about how catalogs work, see the main [Extensions README](README.md#extension-catalogs).
...
- Required Specto version and any tool dependencies
