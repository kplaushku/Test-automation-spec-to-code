...
Complete guide for using Specto extensions to enhance your workflow.
...
Extensions are modular packages that add new commands and functionality to Specto without bloating the core framework. They allow you to:
...
- Specto version 0.1.0 or higher
...
- **Specto Issues**: <https://github.com/statsperform/spec-kit/issues>
